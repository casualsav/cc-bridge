...
export type Access = {
  ...
  spawnAuto?: boolean      // ONE toggle over BOTH dials: an AGENT's spawn rides the spawning orchestrator's --model/--effort, and where it names neither, the defaults above are a FALLBACK the confirmation reports as one. Human-originated spawns never consult it. Default off
