...
Drive a Claude Code session from **Slack**. The sibling of the Telegram bridge (`telegram@claude-tg`)
...
plugin, add the SessionStart hook, restart once, then launch work sessions with `claude-tg`.
