...
const PREF_KEYS = [
  ...
  'chatMapAutowire', 'fileBrowser', 'spawnModel', 'spawnEffort', 'spawnMode', 'chatModel', 'chatEffort', 'chatMode', 'spawnAuto', 'spawnAgentModels', 'spawnHoldMinutes', 'modelCardChat', 'fableForAgents',
  'chatHarness', 'codeHarness', 'chatLaneReasoning',
