...
git clone -b <branch> https://github.com/casualsav/claude-tg
```
...
/plugin marketplace add ./claude-tg
...
```bash
claude --dangerously-load-development-channels plugin:telegram@claude-tg
```
